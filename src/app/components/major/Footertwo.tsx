    ...
    <footer className="w-full relative overflow-hidden">
      ...
      <div className="w-full flex justify-center lg:pl-24 lg:pr-16 px-[22px]">
        <div className="w-full flex flex-col max-w-[1279px] items-center text-center">
          ...
          {/* Added company information here */}
          <div className="text-xs sm:text-sm text-myblack font-normal w-full pb-4 text-center">
            <p>Address: 17, Damole Street, Bariga, Lagos</p>
            <p className="mt-2">Credbevy is a product of Stripling Technology Solutions Limited</p>
          </div>
